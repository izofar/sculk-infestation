...
public class SkulkTntEntity extends TntEntity {

    private final float power = 8.0F;
    @Nullable
    private LivingEntity causingEntity;

    public SkulkTntEntity(EntityType<? extends SkulkTntEntity> entityType, World world) { super(entityType, world); }

    private SkulkTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(ModEntityTypes.SKULK_TNT, world);
    ...
    public static SkulkTntEntity of(World world, double x, double y, double z, @Nullable LivingEntity igniter){
        return new SkulkTntEntity(world, x, y, z, igniter);
    }
