...
public class SkulkedSkeletonModel extends BipedEntityModel<SkulkedSkeleton> implements PartedModel{
    ...
    public SkulkedSkeletonModel(ModelPart root) {
        super(root);
        this.root = root;
    }
    ...
    @Override
    public void animateModel(SkulkedSkeleton mobEntity, float f, float g, float h) {
    ...
    @Override
    public void setAngles(SkulkedSkeleton mobEntity, float f, float g, float h, float i, float j) {
