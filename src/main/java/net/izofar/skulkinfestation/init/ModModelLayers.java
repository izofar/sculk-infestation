...
import net.izofar.skulkinfestation.client.renderer.SkulkTntEntityRenderer;
...
public class ModModelLayers {
    ...
    public static final EntityModelLayer SKULK_TNT = new EntityModelLayer(new Identifier(SkulkInfestation.MOD_ID, "skulk_tnt"), "main");
    ...
    public static void registerModelRenderers() {
        ...
        EntityRendererRegistry.register(ModEntityTypes.SKULK_TNT, SkulkTntEntityRenderer::new);
        ...
        //EntityModelLayerRegistry.registerModelLayer(SKULK_TNT, BlockModels.getModelId());
    }
}
