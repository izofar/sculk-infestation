...
public class SculkedCreeper extends CreeperEntity implements SculkEntity {
    ...
    public SculkedCreeper(EntityType<? extends CreeperEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createMobAttributes() {
        return HostileEntity.createHostileAttributes().add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.3f);
    }
