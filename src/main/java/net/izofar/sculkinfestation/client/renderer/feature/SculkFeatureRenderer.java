...
public class SculkFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
    private final Identifier texture;
    private final AnimationAngleAdjuster animationAngleAdjuster;
    private final ModelPartVisibility modelPartVisibility;

    public SculkFeatureRenderer(FeatureRendererContext<T, M> context, Identifier texture, AnimationAngleAdjuster animationAngleAdjuster, ModelPartVisibility modelPartVisibility) {
        super(context);
