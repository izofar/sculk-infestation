 ...
 * Source: https://github.com/Alex-the-666/AlexsMobs/blob/1.19/src/main/java/com/github/alexthe666/alexsmobs/client/model/ModelCaveCentipede.java
 */
public class CaveCentipedeModel<T extends LivingEntity> extends AdvancedEntityModel<T> {
    ...
    public CaveCentipedeModel(int type) {
        texWidth = 128;
        texHeight = 128;
        this.type = type;
    ...
    public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(type == 0){
            ...
            if(entity instanceof CentipedeBody){
                float offset = (float) ((((CentipedeBody)entity).getBodyIndex() + 1 ) * Math.PI * 0.5F);
                ...
                this.body.rotationPointY += (float)(Math.sin( (ageInTicks * 0.1) - walkOffset) * 0.01);
            ...
            if(entity instanceof CentipedeBody) {
                ...
                this.tail.rotationPointY += (float)(Math.sin( (ageInTicks * 0.1) - walkOffset) * 0.01);
